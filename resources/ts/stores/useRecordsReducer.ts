    ...
    switch ( action.type ) {
        case 'SET_RECORDS':
            return Object.assign( {}, newState, {
                records: orderBy( unionBy( newState.records, action.payload, 'id' ), ( post: any ) => post.date, [
                    'desc',
                ] ),
            } );
...
const useRecordsReducer = ( initialState = defaultState ) => {
...
export default useRecordsReducer;
