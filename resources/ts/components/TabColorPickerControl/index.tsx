...
import { Tooltip, BaseControl, RangeControl, Button, TextControl } from '@wordpress/components';
import { getIcon } from '../../utils';

const TabColorPickerControl = ( props: ColorPickerControlsProps ): JSX.Element => {
    ...
    return (
        <div className="enokh-blocks-color-component__wrapper">
            <>
                <Component
                    color={ rgbColor }
                    onChange={ ( nextColor ) => {
...
export default TabColorPickerControl;
