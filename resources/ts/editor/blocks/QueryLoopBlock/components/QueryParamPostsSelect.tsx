...
import { useDebounceState, usePersistentPostRecords } from '@enokh-blocks/stores';

const QueryParamPostsSelect = ( props ) => {
    const { postType, label, value, placeholder, ...restProps } = props;
...
export default QueryParamPostsSelect;
