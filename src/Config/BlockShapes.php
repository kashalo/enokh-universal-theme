...
class BlockShapes
{
    ...
    public static function get(): array
    {
        return [
            'gb-waves' => [
                'group' => esc_attr__('Waves', 'mah-blocks'),
                'shapes' => [
                    'gb-waves-1' => [
                        'label' => sprintf(__('Wave %s', 'mah-blocks'), '1'),
                    ...
                    'gb-waves-2' => [
                        'label' => sprintf(__('Wave %s', 'mah-blocks'), '2'),
                    ...
                    'gb-waves-3' => [
                        'label' => sprintf(__('Wave %s', 'mah-blocks'), '3'),
                    ...
                    'gb-waves-4' => [
                        'label' => sprintf(__('Wave %s', 'mah-blocks'), '4'),
                    ...
                    'gb-waves-5' => [
                        'label' => sprintf(__('Wave %s', 'mah-blocks'), '5'),
                    ...
                    'gb-waves-6' => [
                        'label' => sprintf(__('Wave %s', 'mah-blocks'), '6'),
                    ...
                    'gb-waves-7' => [
                        'label' => sprintf(__('Wave %s', 'mah-blocks'), '7'),
                    ...
                    'gb-waves-8' => [
                        'label' => sprintf(__('Wave %s', 'mah-blocks'), '8'),
            ...
            'gb-angles' => [
                'group' => esc_attr__('Angles', 'mah-blocks'),
                'shapes' => [
                    'gb-angle-1' => [
                        'label' => sprintf(__('Angle %s', 'mah-blocks'), '1'),
                        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 360" preserveAspectRatio="none"><path d="M1200 360H0V0l1200 348z"/></svg>',
                    ],
                ],
            ],
            'gb-curves' => [
                'group' => esc_attr__('Curves', 'mah-blocks'),
                'shapes' => [
                    'gb-curve-1' => [
                        'label' => sprintf(__('Curve %s', 'mah-blocks'), '1'),
                    ...
                    'gb-curve-2' => [
                        'label' => sprintf(__('Curve %s', 'mah-blocks'), '2'),
                    ...
                    'gb-curve-3' => [
                        'label' => sprintf(__('Curve %s', 'mah-blocks'), '3'),
                    ...
                    'gb-curve-4' => [
                        'label' => sprintf(__('Curve %s', 'mah-blocks'), '4'),
            ...
            'gb-triangles' => [
                'group' => esc_attr__('Triangles', 'mah-blocks'),
                'shapes' => [
                    'gb-triangle-1' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '1'),
                    ...
                    'gb-triangle-2' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '2'),
                    ...
                    'gb-triangle-3' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '3'),
                    ...
                    'gb-triangle-4' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '4'),
                    ...
                    'gb-triangle-5' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '5'),
                    ...
                    'gb-triangle-6' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '6'),
                    ...
                    'gb-triangle-7' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '7'),
                    ...
                    'gb-triangle-8' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '8'),
                    ...
                    'gb-triangle-9' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '9'),
                    ...
                    'gb-triangle-10' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '10'),
                    ...
                    'gb-triangle-11' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '11'),
                    ...
                    'gb-triangle-12' => [
                        'label' => sprintf(__('Triangle %s', 'mah-blocks'), '12'),
