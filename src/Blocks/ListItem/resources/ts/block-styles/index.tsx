...
const BlockStyles: React.FunctionComponent< BlockEditProps > = ( props ) => {
    ...
    return (
        <>
            <MainStyle { ...props } deviceType="" />
            { deviceType && (
                <>
                    { [ 'Tablet', 'Mobile' ].includes( deviceType ) && <MainStyle { ...props } deviceType="Tablet" /> }
                    { [ 'Mobile' ].includes( deviceType ) && <MainStyle { ...props } deviceType={ deviceType } /> }
                </>
            ) }
        </>
    );
